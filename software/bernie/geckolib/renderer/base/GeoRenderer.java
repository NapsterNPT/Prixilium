...
public interface GeoRenderer<T extends GeoAnimatable, O, R extends GeoRenderState> {
	 ...
	 */
	@Nullable
	default class_1921 getRenderType(R renderState, class_2960 texture) {
	 ...
	 */
	default void defaultRender(R renderState, class_4587 poseStack, class_4597 bufferSource, @Nullable class_1921 renderType, @Nullable class_4588 buffer) {
	 ...
	 */
	default void reRender(R renderState, class_4587 poseStack, BakedGeoModel model, class_4597 bufferSource, class_1921 renderType, class_4588 buffer,
	 ...
	 */
	default void actuallyRender(R renderState, class_4587 poseStack, BakedGeoModel model, @Nullable class_1921 renderType,
	 ...
	 */
	default void preApplyRenderLayers(R renderState, class_4587 poseStack, BakedGeoModel model, @Nullable class_1921 renderType, class_4597 bufferSource, @Nullable class_4588 buffer,
									  int packedLight, int packedOverlay, int renderColor) {
		Reference2ObjectMap<GeoBone, Pair<MutableObject<class_4587.class_4665>, PerBoneRender<R>>> perBoneTasks = getPerBoneTasks(renderState);
	 ...
	 */
	default void applyRenderLayers(R renderState, class_4587 poseStack, BakedGeoModel model, @Nullable class_1921 renderType, class_4597 bufferSource, @Nullable class_4588 buffer,
								   int packedLight, int packedOverlay, int renderColor) {
		for (Reference2ObjectMap.Entry<GeoBone, Pair<MutableObject<class_4587.class_4665>, PerBoneRender<R>>> perBoneTask : getPerBoneTasks(renderState).reference2ObjectEntrySet()) {
	 ...
	 */
	default void preRender(R renderState, class_4587 poseStack, BakedGeoModel model, @Nullable class_4597 bufferSource, @Nullable class_4588 buffer, boolean isReRender,
						   int packedLight, int packedOverlay, int renderColor) {}
	 ...
	 */
	default void postRender(R renderState, class_4587 poseStack, BakedGeoModel model, class_4597 bufferSource, @Nullable class_4588 buffer, boolean isReRender,
							int packedLight, int packedOverlay, int renderColor) {}
	 ...
	 */
	default void renderFinal(R renderState, class_4587 poseStack, BakedGeoModel model, class_4597 bufferSource, @Nullable class_4588 buffer,
							 int packedLight, int packedOverlay, int renderColor) {}
	 ...
	 */
	default void renderRecursively(R renderState, class_4587 poseStack, GeoBone bone, class_1921 renderType, class_4597 bufferSource, class_4588 buffer,
								   boolean isReRender, int packedLight, int packedOverlay, int renderColor) {
		poseStack.method_22903();
		RenderUtil.prepMatrixForBone(poseStack, bone);

		if (!isReRender) {
			Pair<MutableObject<class_4587.class_4665>, PerBoneRender<R>> boneRenderTask = getPerBoneTasks(renderState).get(bone);

			if (boneRenderTask != null)
				boneRenderTask.left().setValue(poseStack.method_23760().method_56822());
		}
	 ...
	 */
	default void renderCubesOfBone(R renderState, GeoBone bone, class_4587 poseStack, class_4588 buffer, int packedLight, int packedOverlay, int renderColor) {
		if (bone.isHidden())
			return;
	 ...
	 */
	default void renderChildBones(R renderState, GeoBone bone, class_4587 poseStack, class_1921 renderType, class_4597 bufferSource, class_4588 buffer,
	 ...
	 */
	default void renderCube(R renderState, GeoCube cube, class_4587 poseStack, class_4588 buffer, int packedLight, int packedOverlay, int renderColor) {
	 ...
	 */
	default void createVerticesOfQuad(R renderState, GeoQuad quad, Matrix4f poseState, Vector3f normal, class_4588 buffer,
									  int packedOverlay, int packedLight, int renderColor) {
		for (GeoVertex vertex : quad.vertices()) {
			Vector3f position = vertex.position();			
			Vector4f vector4f = poseState.transform(new Vector4f(position.x(), position.y(), position.z(), 1.0f));

			buffer.method_23919(vector4f.x(), vector4f.y(), vector4f.z(), renderColor, vertex.texU(),
	 ...
	 */
	default void adjustPositionForRender(R renderState, class_4587 poseStack, BakedGeoModel model, boolean isReRender) {}
	 ...
	 */
	default void scaleModelForRender(R renderState, float widthScale, float heightScale, class_4587 poseStack, BakedGeoModel model, boolean isReRender) {
	 ...
	 */
	boolean firePreRenderEvent(R renderState, class_4587 poseStack, BakedGeoModel model, class_4597 bufferSource);

	/**
	 * Create and fire the relevant {@code Post-Render} event hook for this renderer
	 */
	void firePostRenderEvent(R renderState, class_4587 poseStack, BakedGeoModel model, class_4597 bufferSource);

	/**
	 * Internal helper method to help with type-resolution of the {@link DataTickets#PER_BONE_TASKS} DataTicket
	 */
    default Reference2ObjectMap<GeoBone, Pair<MutableObject<class_4587.class_4665>, PerBoneRender<R>>> getPerBoneTasks(R renderState) {
